...
<div class="card bg-light-info shadow-none position-relative overflow-hidden">
  <div class="card-body px-4 py-3">
    <div class="row align-items-center">
      <div class="col-9">
        <h4 class="fw-semibold mb-8">Macidai Store</h4>
  ...
  <div class="shop-part d-flex w-100">
    <div class="shop-filters flex-shrink-0 border-end d-none d-lg-block">
      <ul class="list-group pt-2 border-bottom rounded-0">
        ...
        <li class="list-group-item border-0 p-0 mx-4 mb-2">
          <a class="d-flex align-items-center gap-2 list-group-item-action text-dark px-3 py-6 rounded-1" href="{{ route('filter_products', array_merge(request()->query(), ['cat_id' => $category->id])) }}">
            <i class="ti ti-brand-drops fs-5"></i>{{ $category->category_name }}
          </a>
        </li>
        @endforeach
      </ul>
      <ul class="list-group pt-2 border-bottom rounded-0">
        ...
        <li class="list-group-item border-0 p-0 mx-4 mb-2">
          <a class="d-flex align-items-center gap-2 list-group-item-action text-dark px-3 py-6 rounded-1" href="{{ route('filter_products', array_merge(request()->query(), ['sort' => 'newest'])) }}">
            <i class="ti ti-ad-2 fs-5"></i>Newest
          </a>
        </li>
        <li class="list-group-item border-0 p-0 mx-4 mb-2">
          <a class="d-flex align-items-center gap-2 list-group-item-action text-dark px-3 py-6 rounded-1" href="{{ route('filter_products', array_merge(request()->query(), ['sort' => 'price_high'])) }}">
            <i class="ti ti-sort-ascending-2 fs-5"></i>Price: High-Low
          </a>
        </li>
        <li class="list-group-item border-0 p-0 mx-4 mb-2">
          <a class="d-flex align-items-center gap-2 list-group-item-action text-dark px-3 py-6 rounded-1" href="{{ route('filter_products', array_merge(request()->query(), ['sort' => 'price_low'])) }}">
