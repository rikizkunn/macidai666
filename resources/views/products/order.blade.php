...
<div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
  <div class="card-body px-4 py-3">
    <div class="row align-items-center">
      <div class="col-9">
        <h4 class="fw-semibold mb-8">{{ $product->product_name }} - Product Detail</h4>
          ...
          <div class="shop-content">
            ...
            <form class="form-horizontal" action="{{ route('order_product') }}" method="POST">
              ...
              <div class="d-sm-flex align-items-center gap-6 pt-8 mb-7">
                <button class="btn d-block btn-primary px-5 py-8 mb-6 mb-sm-0" type="submit">Buy Now</button>
              </form>
