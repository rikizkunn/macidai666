        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="product_name" class="form-control" placeholder="Netflix 1 Bulan">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="brand" class="form-control" placeholder="Netflix">
                    <p class="fs-2">Brand of the product </p>
                </div>
                <div>
                    <label class="form-label">Description</label>
                    <textarea id="mymce" name="product_description"></textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="option" class="form-control" id="nametext" aria-describedby="name" placeholder="1 ">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="stock" class="form-control" value="6029">
